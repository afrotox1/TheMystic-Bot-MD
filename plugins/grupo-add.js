...
let link = 'https://chat.whatsapp.com/' + await conn.groupInviteCode(group)
      ...
      await conn.reply(text+'@s.whatsapp.net', `مرحبا! أقدم نفسي ، أنا The-Shadow-MD ✨ وأنا من بوت واتساب ، شخص من المجموعة استخدم الأمر لإضافتك إلى المجموعة ، لكن لم أستطع إضافتك ، لذلك أرسل لك الدعوة لتضيف نفسك ، سننتظرك!!\n\n${link}`, m, {mentions: [m.sender]})
