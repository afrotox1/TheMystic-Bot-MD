...
await m.reply(`${fg}\`\`\`اسف لم استطع ترجمه نصك قم بابلاغ المطور\`\`\``)    
}}}
handler.command = /^(translate|ترجمه|ترجمة|traducir|trad)$/i
